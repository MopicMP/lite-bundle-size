...
> Lite check js bundle size and limits

[![PyPI version](https://badge.fury.io/py/lite-bundle-size.svg)](https://pypi.org/project/lite-bundle-size/)
...
```bash
pip install lite-bundle-size
```

## Quick Start

```python
from lite_bundle_size import size
...
from lite_bundle_size import batch
